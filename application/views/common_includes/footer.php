			...
			<div class="row">
				<div class="col-lg-3 col-md-6 col-sm-6">
					...
					<div class="collapse show" id="collapse_ft_1">
						<ul class="links">
							<li><a href="<?=base_url()?>article/read/about-us">About us</a></li>
							<li><a href="<?=base_url()?>article/read/faq">Faq</a></li>
							<li><a href="<?=base_url()?>article/read/help">Help</a></li>
							<li><a href="<?=base_url()?>my_account">My account</a></li>
							<li><a href="<?=base_url()?>register">Create account</a></li>
							<li><a href="<?=base_url()?>contact_us">Contacts</a></li>
						</ul>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 col-sm-6">

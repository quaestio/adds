                            ...
                            <div class="box">
                                ...
                                <div class="box-tools">
		                         <div class="input-group">
		                           <input type="text" class="form-control input-sm pull-right" style="width: 150px;"  name="enquiry" id="enquiry">
	...
	<script type="text/javascript">
							...
							$(document).ready(function () {
								...
								$('#BodyTable').jtable({
									...
									pageSize: 10,
									sorting: true,
									defaultSorting: 'date_enquired desc',
									
									actions: {
										listAction: '<?php echo base_url();?>enquiry/enquiry_list/list',
																		
														
									},
									fields: {
										
										enquiry_id: {	key: true,title: ' ',edit: false,list: false,title: ''},
										enquiry_by: {create: true,edit: true,list: true,title: 'ASKED BY',inputClass: 'validate[required]'},
										mobile: {create: true,edit: true,list: true,title: 'MOBILE',inputClass: 'validate[required]'},
										email: {create: false,edit: false,list: true,title: 'EMail'},
										message: {create: false,edit: false,list: true,title: 'MESSAGE'},
										date_enquired: {create: false,edit: false,list: true,title: 'DATE ENQUIRED'},
			...
			<input type="hidden" id="enquiry_select" />
    </body>
</html>